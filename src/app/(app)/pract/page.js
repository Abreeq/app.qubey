                ...
                <div className="space-y-6">
                    ...
                    <div className="px-2 sm:px-4 lg:px-6 pt-6 space-y-4 sm:space-y-6">
                        {visibleReports.map((report) => (
                            <div key={report.id} className="flex flex-col md:flex-row flex-wrap md:items-center md:justify-between gap-3 md:gap-1 p-4 rounded-xl border border-purple-300 bg-white hover:bg-purple-50 hover:shadow-md hover:-translate-y-0.5 duration-300 transition-all">
                                {/* Date */}
                                ...
                                <div className="flex items-center gap-4">
                                    <button className="flex items-center justify-center p-2 rounded-lg cursor-pointer active:scale-90
