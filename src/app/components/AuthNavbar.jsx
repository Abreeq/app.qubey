...
export default function Header() {
    ...
    const LANDING_URL = "https://staging.qubey.ae";
    const navLinks = [
        { href: `${LANDING_URL}/`, label: "Home" },
        { href: `${LANDING_URL}/about`, label: "About" },
        { href: `${LANDING_URL}/#solutions`, label: "Solutions" },
        { href: `${LANDING_URL}/#why`, label: "Why Qubey" },
        { href: `${LANDING_URL}/#pricing`, label: "Pricing" },
    ];
        ...
        <>
            <header className="sticky top-0 z-50 w-full border-b border-black/10 bg-white">
                <div className="custom-container flex h-18 items-center justify-between">
                    ...
                    {/* Logo */}
                    <Link ref={logoRef} href="https://staging.qubey.ae/" onClick={(e) => handleNavClick(e, "/")} className="text-2xl">
                        <img src="/logo.png" alt="Qubey Logo" className='h-10 sm:h-12 w-auto object-contain' />
                    </Link>
